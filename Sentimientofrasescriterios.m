...
% palabras clave
keywords = {...
    'costo', 'costos', 'ahorro', 'ahorros', 'financiero', 'financieros', 'inversión', 'inversiones', ...
    'incentivo', 'incentivos', 'fiscal', 'descuento', 'descuentos', 'subsidio', 'bonificación', ...
    'reducción de impuestos', 'económico', 'ingresos', 'beneficios', 'ingreso', ...
    'sostenible', 'sostenibles', 'emisiones', 'emisión', 'contaminación', 'contaminaciones', ...
    'carbono', 'reducción de emisiones', 'carbono neutralidad', 'contaminación acústica', ...
    'ambiental', 'energías renovables', 'residuos', ...
    'tecnología', 'infraestructura', 'eficiencia', 'innovación', 'estación de carga', ...
    'red de carga', 'electroterminales', 'buses eléctricos', 'adopción tecnológica', 'técnico', ...
    'avances técnicos', 'desarrollo tecnológico', 'capacitación técnica', ...
    'política', 'regulación', 'ley', 'gobierno', 'Estrategia Nacional', ...
    'acuerdos público-privados', 'Ley de Transición Energética', 'político', 'normativa', ...
    'acuerdos', 'político-privados', 'alianzas', ...
    'sociedad', 'personas', 'comunidad', 'impacto', 'impacto social', 'calidad de vida', ...
    'beneficios sociales', 'participación ciudadana', 'educación', 'sensibilización', ...
    'social', 'inclusión', 'aceptación social'}; 


% Análisis de Sentimiento
sentimentScores = analyzeSentiment(text, keywords);
disp('Scores de Sentimiento:'); 
